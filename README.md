...
> 列表生成时间: 2026-09-08 06:00 | 地址: 402 | 可用: 348 | 不可用: 54
> 实际检测时间范围: 2026-09-08 06:00 至 2026-09-08 06:06 | 本次检测: 402 | 复用缓存: 0

| 分类 | 频道数（源数） | 质量分布 |
|------|-------------|---------|
| CCTV | 37（91） | 4K:2, FHD:33, SD:2 |
| 各省卫视 | 37（112） | 4K:9, FHD:25, SD:3 |
| 深圳频道 | 5（7） | FHD:4, SD:1 |
| 广东省级频道 | 13（24） | 4K:1, FHD:12 |
| 省级和国家级频道 | 12（16） | FHD:7, SD:5 |
| 广东地方频道 | 29（30） | FHD:29 |
| IPTV主题频道 | 21（33） | FHD:16, SD:5 |
| 其他 | 9（12） | FHD:2, SD:7 |
| **合计** | **163（325）** | **4K:12, FHD:128, SD:23** |
