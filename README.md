...
> 列表生成时间: 2026-09-09 06:00 | 地址: 402 | 可用: 348 | 不可用: 54
> 实际检测时间范围: 2026-09-09 06:00 至 2026-09-09 06:06 | 本次检测: 402 | 复用缓存: 0

| 分类 | 频道数（源数） | 质量分布 |
|------|-------------|---------|
| CCTV | 36（91） | 4K:2, FHD:32, SD:2 |
...
| 其他 | 9（12） | FHD:2, SD:7 |
| **合计** | **165（325）** | **4K:12, FHD:130, SD:23** |
